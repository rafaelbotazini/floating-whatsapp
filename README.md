...
This is a ~~very simple~~ multi-text fake WhatsApp chat plugin for jQuery.

It adds a floating-like button to your site that calls the [WhatsApp Click to Chat API](https://faq.whatsapp.com/en/26000030/).

It will automatically begin a WhatsApp button with the number you specify.

You an also activate a fake chat window animation with a customized message where the user can input their reply before opening WhatsApp.
...
```
<img src="custom-settings.gif" alt="Exemplo de arquivo GIF" width="300" height="300" />
...
| popupMessage        | `array`                                      | `['']`                     | Array of messages to be shown as a received message in the fake chat.
...
| headerTypingMessage | `string`                                      | `'typing...'`            | Text to be displayed at the popup window title bar when popup message animation still running.
